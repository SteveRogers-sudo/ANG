...
export class HttpClientService {
  ...
  public displayCenters() {
    return this.httpClient.get<DiagnosticCentre>("http://localhost:2070/appointment/getCenterList");
  }
  public displayTests(selectedCenterId) {
    console.log(selectedCenterId)
    return this.httpClient.get<Test>("http://localhost:2070/appointment/getTestList/" + selectedCenterId);

  }
  public makeAppointment(app) {

    return this.httpClient.post<any>("http://localhost:2070/appointment/makeAppointment", app);

  }
  public displayAppointments() {
    return this.httpClient.get<Appointment>("http://localhost:2070/appointment/getAppointmentList");
  }

  public approveAppointment(app) {
    return this.httpClient.put<any>("http://localhost:2070/appointment/approveAppointment", app, { responseType: 'json' });
